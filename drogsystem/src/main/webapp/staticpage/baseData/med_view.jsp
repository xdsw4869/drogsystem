  ...
  <div class="div1">
       ...
       <tr bgcolor="#FFFFFF" >
		  ...
		  <td rowspan="7" width="350" align="center" valign="middle">				
	          		<img src="../upload/xxx.png" width="320" alt="药品图片"	height="220" />
		  </td>
        </tr>
        <tr bgcolor="#FFFFFF" >
        ...
        <tr bgcolor="#FFFFFF" >
          ...
          <td align="left" colspan="3">牛黄解毒丸</td>
        </tr>
        <tr bgcolor="#FFFFFF" >
